...
describe RawProgram do
  ...
  it "is invalid without a title" do
    FactoryGirl.build(:raw_program, title: nil).should_not be_valid
  end
  
  it "is invalid without a region_name" do
    FactoryGirl.build(:raw_program, region_name: nil).should_not be_valid
  end
  
  it "is invalid without a channel_xmltv_id" do
    FactoryGirl.build(:raw_program, channel_xmltv_id: nil).should_not be_valid
  end
    
  it "is invalid without a start date/time" do
    FactoryGirl.build(:raw_program, start_datetime: nil).should_not be_valid
  end
  
  it "is invalid without an end date/time" do
    FactoryGirl.build(:raw_program, end_datetime: nil).should_not be_valid
  end
